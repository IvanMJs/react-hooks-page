      ...
      <Flex mt="5%" display="-ms-grid" textAlign="center">
        ...
        <Flex display="grid" mt="10%">
          <Text fontSize="3xl" margin="auto" width="80%" color="#FFFFFF">
            ...
            **action**. Veamos como crear el **initialState** y el **reducer**.
            Para ello usaremos el hook `useReducer` para añadir los personajes
            de Rick y Morty que queramos a favoritos.
          </Text>
          <Flex
            height="30vh"
            overflow="scroll"
